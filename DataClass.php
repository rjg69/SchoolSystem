...
-->
<div class="btn-group">
    <button type="button" class="btn btn-primary" width = "100%" onclick = "ManagementSystem.php?add()">Add</button>
    <button type="button" class="btn btn-primary" width = "100%" onclick = "ManagementSystem.php?delete()">Remove</button>
</div>
